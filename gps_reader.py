"""
wifi-logger: GPS reader
Thread-safe singleton that connects to gpsd and keeps the latest TPV report.
Reconnects automatically on connection loss.

gpsd must be running and pointing at the T-Beam USB serial device.
